...
const [rX, rY0, rInstanceProp, rStaticMethod, rStaticProp, rInstanceMethod] =
  test.ranges();
verify.navigateTo(
  { pattern: "x", expected: [{ name: "x", kind: "konst", range: rX }] },
  {
    pattern: "y",
  ...
  },
  {
    ...
    expected: [
      { name: "staticProperty", kind: "property", range: rStaticProp },
    ],
  },
  {
    pattern: "instanceMethod",
    expected: [
      { name: "instanceMethod", kind: "method", range: rInstanceMethod },
    ],
  }
);
